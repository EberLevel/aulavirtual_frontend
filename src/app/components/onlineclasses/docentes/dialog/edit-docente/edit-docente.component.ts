...
export class EditDocenteComponent {
    ...
    ngOnInit() {
        ...
        const tipoDoc = this.tipodocu.find(
            (item) => item.name == this.config.data.tipo_documento
        );
        if (tipoDoc) {
        ...
        const tipoGenero = this.tipoGenero.find(
            (item) => item.name == this.config.data.genero
        );
        if (tipoGenero) {
            this.tipoGeneroSeleccionado = {
                name: tipoGenero.name,
                value: tipoGenero.value,
            };
        }
